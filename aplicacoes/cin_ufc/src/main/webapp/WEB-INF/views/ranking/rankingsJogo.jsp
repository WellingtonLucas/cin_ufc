				...
				<div class="row">
					...
					<div class="col-sm-8 col-sm-offset-4 col-md-10 col-md-offset-2 main">
						<div class="jumbotron">
					        ...
					        <div>
					        	<a class="btn btn-lg btn-success col-sm-3" href="<c:url value="/jogo/${jogo.id }/rankings-alunos"></c:url>" role="button">Alunos <i class="glyphicon glyphicon-list"></i></a>
					        </div>
					        <div class="col-sm-1"></div>
					        <div>
					        	<a class="btn btn-lg btn-primary col-sm-3" href="<c:url value="/jogo/${jogo.id }/rankings-equipes"></c:url>" role="button">Equipes <i class="glyphicon glyphicon-list"></i></a>
					        </div>
					    </div> 
