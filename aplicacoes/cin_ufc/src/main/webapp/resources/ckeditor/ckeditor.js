        ...
        CKEDITOR.tools = {
            ...
            buildStyleHtml: function(a) {
                for (var a = [].concat(a), e, d = [], b = 0; b < a.length; b++)
                    if ((e = a[b])){
                    	/@import|[{}]/.test(e) ? d.push("<style>" + e + "</style>") : d.push('<link type="text/css" rel=stylesheet href="' + e + '">');
                    }
                return d.join("")
            },
                ...
                f = function() {
                    ...
                    d.attachListener(d, "focus", function() {
                        ...
                        if ((b || d) && a._.savedSelection)
                            for (var d = a._.savedSelection.getSelectedElement(), d = !d && a._.savedSelection.getRanges(), i = 0; i < d.length; i++) e = d[i], c = e.startContainer.getText().length, (c < e.startOffset || c < e.endOffset) && a.unlockSelection(!1)
                    }, this, null, -10)
                },
                h = function() {
