		...
		<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			...
			<div id="myTabContent" class="tab-content">
				...
				<div class="tab-pane fade" id="profile">
					<form:form id="senha" role="form" class="form-horizontal"
						commandName="usuario" servletRelativeAction="atualizarSenha"
						method="POST">
						<form:hidden path="id" value="${usuario.id }" />
						<form:hidden path="papel" value="${usuario.papel }" />
						<form:hidden path="habilitado" value="${usuario.habilitado }" />
						<form:hidden path="email" value="${usuario.email }" />
						<form:hidden path="curso" value="${usuario.curso }" />
						<form:hidden path="nome" value="${usuario.nome }" />
						<form:hidden path="sobreNome" value="${usuario.sobreNome }" />
						<br>
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<form:password id="senha" path="senha"
